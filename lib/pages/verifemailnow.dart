...
// import 'package:gpsid/model/profileModel.model.dart';
...
class VerifEmailNow extends StatefulWidget {
  final bool darkMode;
  const VerifEmailNow({Key? key, required this.darkMode}) : super(key: key);

  @override
  State<VerifEmailNow> createState() => _VerifEmailNowState();
}

class _VerifEmailNowState extends State<VerifEmailNow> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          AppLocalizations.of(context)!.verifEmailButton,
          style: bold.copyWith(
            fontSize: 16,
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  if (snapshot.data is ErrorTrapModel) {
                    ...
                    profileModel = snapshot.data as ProfileModel;
                    return Padding(
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  suffixIcon: Visibility(
                                      visible:
                                          _oldEmail.text.isEmpty ? false : true,
                                      child: InkWell(
                                        onTap: () {
                                          _oldEmail.clear();
                                        },
                                  ...
                                  hintText: profileModel.data.result.email,
