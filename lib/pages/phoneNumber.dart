...
class PhoneNumber extends StatefulWidget {
  final bool darkMode;
  const PhoneNumber({Key? key, required this.darkMode}) : super(key: key);
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(AppLocalizations.of(context)!.newPhoneNumber,
                                  style: bold.copyWith(
                                    fontSize: 14,
                                    color: blackPrimary,
                                  )),
                        ...
                        Row(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  _newPhoneNumber.text.isEmpty
                                      ? showInfoAlert(
                                          context, 'Nomor handphone kosong', '')
                                      : doGetOTP(_newPhoneNumber.text
                                              .substring(0, 3)
                                              .contains('620')
                                          ? _newPhoneNumber.text
                                              .replaceRange(0, 3, '62')
                                          : _newPhoneNumber.text[0] == '8'
                                              ? '62${_newPhoneNumber.text}'
                                              : _newPhoneNumber.text[0] == '0'
                                                  ? _newPhoneNumber.text
                                                          .substring(0)
                                                          .contains('0')
                                                      ? _newPhoneNumber.text
                                                          .replaceRange(
                                                              0, 1, '62')
                                                      : _newPhoneNumber.text
                                                  : _newPhoneNumber.text[0] ==
                                                          '+'
                                                      ? _newPhoneNumber.text
                                                          .replaceRange(
                                                              0, 3, '62')
                                                      : _newPhoneNumber.text[1] ==
                                                              '0'
                                                          ? _newPhoneNumber.text
                                                              .replaceRange(
                                                                  0, 1, '62')
                                                          : _newPhoneNumber.text
                                                                  .substring(
                                                                      0, 2)
                                                                  .contains('62')
                                                              ? _newPhoneNumber.text.replaceRange(0, 2, '62')
                                                              : _newPhoneNumber.text);
                                },
                                style: ElevatedButton.styleFrom(
                                    shape: RoundedRectangleBorder(
