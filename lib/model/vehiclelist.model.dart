...
class VehicleListModel {
  ...
  late final DataVehicleList data;

  VehicleListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = DataVehicleList.fromJson(json['data']);
  }
...
class DataVehicleList {
  DataVehicleList({
    required this.totalAllData,
    required this.result,
  });
  late final int totalAllData;
  late final List<ResultVehicleList> result;

  DataVehicleList.fromJson(Map<String, dynamic> json) {
    totalAllData = json['TotalAllData'];
    result = List.from(json['result'] ?? {})
        .map((e) => ResultVehicleList.fromJson(e))
        .toList();
  }
...
class ResultVehicleList {
  ...
  ResultVehicleList.fromJson(Map<String, dynamic> json) {
    imei = json['Imei'];
    ...
    gsmNo = json['Gsm_no'];
    vehType = json['Veh_type'] == '' ? 'car' : json['Veh_type'];
