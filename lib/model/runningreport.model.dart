...
class RunningReportModel {
  ...
  late final DataRunningReport data;

  RunningReportModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = DataRunningReport.fromJson(json['data']);
  }
...
class DataRunningReport {
  ...
  late final int totalRunningTime;
  late final List<ResultRunningReport> result;

  DataRunningReport.fromJson(Map<String, dynamic> json) {
    ...
    result = List.from(json['result'])
        .map((e) => ResultRunningReport.fromJson(e))
        .toList();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['TotalRunningTime'] = totalRunningTime;
    _data['result'] = result.map((e) => e.toJson()).toList();
    return _data;
  }
}

class ResultRunningReport {
  ResultRunningReport({
    required this.imei,
    required this.plate,
    required this.gsmNo,
  ...
  ResultRunningReport.fromJson(Map<String, dynamic> json) {
    imei = json['Imei'];
    plate = json['Plate'];
    gsmNo = json['Gsm_no'];
